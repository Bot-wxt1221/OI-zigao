/***
 * @Author: Zi_Gao
 * @Date: 2022-01-28 13:59:53
 * @LastEditTime: 2022-01-28 14:04:26
 * @LastEditors: Zi_Gao
 * @Description: 
 */
/**
...
class    _normal_mul
{
    ...
    public:
    Vec multi(Vec& AA,Vec& BB) { return mul(AA,BB); }
};
...
class _data_container_of_BigN
{
    ...
    _this_class operator=(const char* str)
    {
        //turn char* to BigN
        int    _n=strlen(str),data=0,base=1,t=0;
        vec.clear(); if(str[0]=='-') sym=true,t=1;
    ...
    bool    is_positive() { return !sym; }
    bool    is_negetive() { return sym; }
    ...
    //get k-th digit
    int    getkth(const int x)
    {
        if(x>=(int)length) return -1;
        return vec[length-x-1];
    }
    //Modify
    bool    modify(const int x,const int y)
    {
    ...
    _this_class operator+(_this_class& B)
    {
    ...
    _this_class operator+(int B){ _this_class t=B; return *this+t; }
    _this_class operator-(int B){ _this_class t=B; return *this-t; }
    _this_class operator*(int B){ _this_class t=B; return *this*t; }
    _this_class operator/(int B){ _this_class t=B; return *this/t; }
    _this_class operator%(int B){ _this_class t=B; return *this%t; }

    _this_class operator+=(_this_class& B) { return *this=*this+B; }
    _this_class operator-=(_this_class& B) { return *this=*this-B; }
    _this_class operator*=(_this_class& B) { return *this=*this*B; }
    _this_class operator/=(_this_class& B) { return *this=*this/B; }
    _this_class operator%=(_this_class& B) { return *this=*this%B; }
    _this_class operator+=(int B) { return *this=*this+B; }
    _this_class operator-=(int B) { return *this=*this-B; }
    _this_class operator*=(int B) { return *this=*this*B; }
    _this_class operator/=(int B) { return *this=*this/B; }
    _this_class operator%=(int B) { return *this=*this%B; }
    ...
    */
    ...
    //resize the vector
    void    resize(int x) { vec.resize(x); }

    int    get_quotient(_this_class& R,_this_class& B,
            _this_class* Map)
    ...
    _this_class positive_add(_this_class& B)
    ...
    _this_class positive_minus(_this_class& B)
    //This func returns Abs(*this)-Abs(B)
    ...
    _this_class positive_muliply(_this_class& B)
    //This func returns Abs(*this)*Abs(B)
    {
        _this_class C=*this;
    ...
    _this_class positive_divide(_this_class& B)
    //This func returns Abs(*this)/Abs(B)
    {
    ...
    _this_class positive_mod(_this_class& B)
    //This func returns Abs(*this)%Abs(B)
    {
        if(B.length==1 && B.vec[0]==0) throw Divide_By_Zero_Error();
        _this_class r;//Remainder
...
class BigN
{
    ...
    int    operator[](const int x) { return _data.getkth(x); }
    ...
    bool    operator < (int B) { return *this<(BigN)B; }
    bool    operator > (int B) { return *this>(BigN)B; }
    bool    operator <= (int B) { return *this<=(BigN)B; }
    bool    operator >= (int B) { return *this>=(BigN)B; }
    bool    operator != (int B) { return *this!=(BigN)B; }
    ...
    void    printn() { _data.print(); printf("\n"); }
    ...
    std::string getstr(){ _data.print_to_str(_Str); return _Str; }
    std::string str() { return _Str; }

    protected:
    std::string _Str;
    void    refresh_str() { _data.print_to_str(_Str); }
...
int main()
{
    ...
    BigN in=a;
    BigN out=0;
    for(BigN i=1;i<=in;i+=1)
    {
        BigN t=1;
        for(BigN j=i;j>1;j-=1){
            t*=j;
        }
        out+=t;
    }
