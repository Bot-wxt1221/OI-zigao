...
long long count(int x1,int y1,int z1,int x2,int y2,int z2){
    return map[x2][y2][z2]-map[x2][y1-1][z2]-map[x1-1][y2][z2]-map[x2][y2][z1-1]+map[x2][y1-1][z1-1]+map[x1-1][y2][z1-1]+map[x1-1][y1-1][z2]-map[x1-1][y1-1][z1-1];
}
